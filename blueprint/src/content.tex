...
\lean{HeytingLean.LoF.PrimaryAlgebra}{HeytingLean.LoF.PrimaryAlgebra}
\uses{}
...
\label{def:reentry}
\lean{HeytingLean.LoF.Nucleus}{HeytingLean.LoF.Reentry}
...
\lean{HeytingLean.LoF.Nucleus}{HeytingLean.LoF.Reentry.idempotent}
\leanok
\uses{def:reentry}
...
\label{def:omega}
\lean{HeytingLean.LoF.Nucleus}{HeytingLean.LoF.Reentry.Omega}
\uses{def:reentry}
...
\lean{HeytingLean.LoF.HeytingCore}{HeytingLean.LoF.Reentry.instHeytingOmega}
\leanok
\uses{def:omega}
...
\lean{HeytingLean.LoF.HeytingCore}{HeytingLean.LoF.Reentry.heyting\_adjunction}
\leanok
...
\lean{HeytingLean.LoF.HeytingCore}{HeytingLean.LoF.Reentry.double\_neg}
\leanok
\uses{thm:heyting-instance}
...
\label{def:process}
\lean{HeytingLean.LoF.Nucleus}{HeytingLean.LoF.Reentry.process}
\uses{def:omega}
...
\lean{HeytingLean.LoF.Nucleus}{HeytingLean.LoF.Reentry.counterProcess}
\uses{def:omega}
...
\lean{HeytingLean.LoF.Nucleus}{HeytingLean.LoF.Reentry.process\_inf\_counter}
\leanok
...
\lean{HeytingLean.LoF.Nucleus}{HeytingLean.LoF.Reentry.eulerBoundary}
\uses{def:process}
...
\lean{HeytingLean.LoF.Nucleus}{HeytingLean.LoF.Reentry.eulerBoundary\_eq\_process}
\leanok
...
\label{thm:tensor-rt}
\lean{HeytingLean.Bridges.Tensor}{Model.decode\_encode}
\leanok
...
\lean{HeytingLean.Bridges.Tensor}{Model.stageMvAdd\_encode}
\leanok
\uses{def:tensor-carrier}
...
\label{thm:graph-rt}
\lean{HeytingLean.Bridges.Graph}{Model.decode\_encode}
\leanok
...
\lean{HeytingLean.Bridges.Graph}{Model.stageEffectAdd\_encode}
\leanok
\uses{def:graph-carrier}
...
\lean{HeytingLean.Bridges.Clifford}{Model.decode\_encode}
\leanok
...
\lean{HeytingLean.Bridges.Clifford}{Model.stageOrthocomplement\_encode}
\leanok
\uses{def:clifford-carrier}
...
\lean{HeytingLean.Logic.ResiduatedLadder}{HeytingLean.Logic.Residuated.abduction}
\uses{}
...
\lean{HeytingLean.Logic.StageSemantics}{HeytingLean.Logic.Stage.MvCore}
\uses{}
...
\lean{HeytingLean.Logic.ModalDial}{HeytingLean.Logic.Modal.DialParam.breathe}
...
\lean{HeytingLean.Tests.Compliance}{HeytingLean.Tests.identity\_round\_verified}
